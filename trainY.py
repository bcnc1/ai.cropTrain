...
# load npys
trainData = np.load('/home/bcncompany/PycharmProjects/RCnpys/trainDataY.npy')
trainLabel = np.load('/home/bcncompany/PycharmProjects/RCnpys/trainLabelY.npy')
testData = np.load('/home/bcncompany/PycharmProjects/RCnpys/testDataY.npy')
testLabel = np.load('/home/bcncompany/PycharmProjects/RCnpys/testLabelY.npy')
