...
# load npys
trainData = np.load('/home/bcncompany/PycharmProjects/RCnpys/trainDataW.npy')
trainLabel = np.load('/home/bcncompany/PycharmProjects/RCnpys/trainLabelW.npy')
testData = np.load('/home/bcncompany/PycharmProjects/RCnpys/testDataW.npy')
testLabel = np.load('/home/bcncompany/PycharmProjects/RCnpys/testLabelW.npy')
