...
# load npys
trainData = np.load('/home/bcncompany/PycharmProjects/RCnpys/trainDataH.npy')
trainLabel = np.load('/home/bcncompany/PycharmProjects/RCnpys/trainLabelH.npy')
testData = np.load('/home/bcncompany/PycharmProjects/RCnpys/testDataH.npy')
testLabel = np.load('/home/bcncompany/PycharmProjects/RCnpys/testLabelH.npy')
